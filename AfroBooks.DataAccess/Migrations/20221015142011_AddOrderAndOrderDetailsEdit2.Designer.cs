...
namespace AfroBooks.Migrations
{
    ...
    [Migration("20221015142011_AddOrderAndOrderDetailsEdit2")]
    partial class AddOrderAndOrderDetailsEdit2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AfroBooks.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AfroBooks.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AfroBooks.Models.ShoppingCartProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("AfroBooks.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("AfroBooks.Models.OrderDetail", b =>
                {
                    ...
                    b.HasOne("AfroBooks.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("AfroBooks.Models.OrderHeader", b =>
                {
                    b.HasOne("AfroBooks.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("AfroBooks.Models.ApplicationUser", b =>
                {
                    b.HasOne("AfroBooks.Models.Company", "Company")
                        .WithMany()
